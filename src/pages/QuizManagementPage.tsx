      ...
      if (res.ok) {
        ...
        for (const session of sessions) {
          if (session.fermiQuiz) {
            const quizRes = await fetch(`/api/quizzes/session/${session.id}`, { headers });
            if (quizRes.ok) {
                ...
                {editingQuizId === quiz.id ? (
                  <div>
                    <h3 style={{ marginBottom: "10px" }}>
                      Edit Questions ({selectedQuestions.length}/10)
                    </h3>
                    ...
                    >
                      <div>
                        <h4 style={{ fontSize: "0.9rem", marginBottom: "8px", color: "#666" }}>
                          Available Questions
                        </h4>
                        <div
                          style={{
                      ...
                      <div>
                        <h4 style={{ fontSize: "0.9rem", marginBottom: "8px", color: "#666" }}>
                          Selected Questions (Order matters!)
                        </h4>
                        <div
                          style={{
                            maxHeight: "400px",
                                  ...
                                  <div style={{ display: "flex", gap: "4px", flexShrink: 0 }}>
                                    ...
                                    <button
                                      ...
                                      style={{
                                        ...
                                        height: "28px",
                                        backgroundColor:
                                          index === selectedQuestions.length - 1 ? "#e0e0e0" : "#f0f0f0",
                                        border: "1px solid #ddd",
                                        borderRadius: "4px",
                                        cursor:
                                          index === selectedQuestions.length - 1 ? "not-allowed" : "pointer",
                                        fontSize: "14px",
